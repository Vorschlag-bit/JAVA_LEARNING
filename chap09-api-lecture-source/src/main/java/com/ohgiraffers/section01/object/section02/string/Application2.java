...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 필기.
        *  문자열 객체를 만드는 방법
        *  1, "" 리터럴 형태: 동일한 값을 가지는 인스턴스(동등(hash랑 equals) 객체)를 단일 인스턴스로 관리한다.(singleton 개념, 상수풀 활용)
        *  2. new String("") 형태: 매번 새로운 인스턴스를 생성한다.(주소값이 매번 다름) */
        ...
        // 문자열 동등 비교를 하는 상수풀에서 비교한다
        // '=='을 쓸 수 있는 건 리터럴 형태의 String뿐이다. 인스턴스를 형성하면 equals를 써야 한다.
        System.out.println("str1 == str2 " + (str1 == str2));    // true (주소값 비교, 둘은 같은 객체다.)
        System.out.println("str2 == str3 " + (str1 == str3));    // false
